...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/public/css/add_report.css">
...
<div class="container">
    ...
    <main>
        ...
        <div class="panel">
            ...
            <form class="add-report-form" action="add_report" method="POST" ENCTYPE="multipart/form-data">
                <input class="type-input" name="type" type="text">
                ...
                <textarea class="description-input" name="description" rows=4></textarea>
